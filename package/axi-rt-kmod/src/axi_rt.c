...
/* Init the axi_rt with a predefined config */
/* Enable bits: bit 0 = CVA6 (mgr 0), bit 4 = ATG (mgr 4) */
#define AXIRT_ENABLE_MASK 0x10
#define AXIRT_MGR_CVA6 0
#define AXIRT_MGR_ATG_OFFSET 3

/* Budget and Period*/
#define AXIRT_CVA6_BUDGET_DEFAULT   8
#define AXIRT_CVA6_PERIOD_DEFAULT   100
#define AXIRT_ATG_BUDGET_DEFAULT    8
#define AXIRT_ATG_PERIOD_DEFAULT    100
...
static void init_axi_rt(struct axirt_dev *axirt, struct cheshire_dev *cheshire, struct device *dev)
{
    ...
    axirt_set_len_limit_group(axirt,
                              AXIRT_LEN_LIMIT_DEFAULT,
    ...
    axirt_set_budget(axirt, AXIRT_CVA6_BUDGET_DEFAULT, 0, AXIRT_MGR_CVA6);
    axirt_set_budget(axirt, AXIRT_CVA6_BUDGET_DEFAULT, 1, AXIRT_MGR_CVA6);
    axirt_set_period(axirt, AXIRT_CVA6_PERIOD_DEFAULT, 0, AXIRT_MGR_CVA6);
    axirt_set_period(axirt, AXIRT_CVA6_PERIOD_DEFAULT, 1, AXIRT_MGR_CVA6);
    ...
    /* Configure ATG (mgr 5) - two subordinate regions */
    ...
    axirt_set_budget(axirt, AXIRT_ATG_BUDGET_DEFAULT, 0, cheshire_atg_id);
    axirt_set_budget(axirt, AXIRT_ATG_BUDGET_DEFAULT, 1, cheshire_atg_id);
    axirt_set_period(axirt, AXIRT_ATG_PERIOD_DEFAULT, 0, cheshire_atg_id);
    axirt_set_period(axirt, AXIRT_ATG_PERIOD_DEFAULT, 1, cheshire_atg_id);
